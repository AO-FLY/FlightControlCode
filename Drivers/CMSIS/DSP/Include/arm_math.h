...
/*  return (sum + ((q15_t) (x >> 16) * (q15_t) y)) + ((q15_t) x * (q15_t) (y >> 16)); */
   ...
   * @param[in]     resetStateFlag  USRAT_flag to reset the state. 0 = no change in state 1 = reset the state.
   */
  ...
  typedef struct
  {
    ...
    uint8_t ifftFlag;                /**< USRAT_flag that selects forward (ifftFlag=0) or inverse (ifftFlag=1) transform. */
    uint8_t bitReverseFlag;          /**< USRAT_flag that enables (bitReverseFlag=1) or disables (bitReverseFlag=0) bit reversal of output. */
...
void arm_cfft_q31(
  ...
  typedef struct
  {
    ...
    uint8_t ifftFlagR;                        /**< USRAT_flag that selects forward (ifftFlagR=0) or inverse (ifftFlagR=1) transform. */
    uint8_t bitReverseFlagR;                  /**< USRAT_flag that enables (bitReverseFlagR=1) or disables (bitReverseFlagR=0) bit reversal of output. */
